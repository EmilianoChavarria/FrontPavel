...
export const ErrorPage = () => {
    return (
        <div class="w-full h-[90vh] flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
            <div class="w-full  flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
